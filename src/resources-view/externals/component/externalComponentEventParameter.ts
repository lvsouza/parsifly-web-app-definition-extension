...
export const loadExternalComponentEventParameter = async ({ extensionContext, current, root, projectId }: TProps): Promise<ListViewItem> => {
      ...
      getItems: async (context) => {
        ...
        return await Promise.all(
          items.map(async item => (
            await loadExternalComponentEventParameter({
              root,
              projectId,
              current: item,
              extensionContext,
